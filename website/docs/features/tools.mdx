---
title: 工具与权限
description: opencode 工具系统：统一注册、统一拦截（权限 + 截断），插件与内置工具同机制。
---
...
详见 [agents-and-skills](./agents-and-skills#子-agent-权限)。

## 相关文档

- 工具在 runner 中的调用：[Session V2 深度](../session-v2-deep-dive)
- 术语：Model Tool Output / Managed Tool Output File / PTY Environment → [术语表](../glossary)
- MCP 工具如何接入：[agents-and-skills](./agents-and-skills#mcp)
